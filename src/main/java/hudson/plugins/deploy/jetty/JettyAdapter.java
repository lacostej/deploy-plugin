...
/**
 * Base class for Jetty adapters.
 *
 * @author Jerome Lacoste
 */
public abstract class JettyAdapter extends PasswordProtectedAdapterCargo {
    public final String url;

    protected JettyAdapter(String url, String password, String userName) {
